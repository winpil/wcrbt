...
public class SysColumnService {
	 ...
	 * @return
	 */
	public SysColumn convert(SysColumn sysColumn){
	 ...
	 * @return
	 */
	public List<SysColumn> findColumnList(String tableName){
	...
	public String toJavaType(String dataType){
		...
		if(Tool.in(dataType, "int","tinyint","smallint","mediumint","integer","bigint","bit")){
			return "Integer";
